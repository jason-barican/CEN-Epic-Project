...
class MainMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        option_menu2['menu'].entryconfig(1, command=lambda: controller.show_frame("InCollegeFeaturesFrame"))
...
class CopyrightNoticeFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Copyright © 2023 Group 3 SE. All rights reserved.\n\n"
                            "This program and its accompanying materials are protected under the copyright laws of United States of America and other countries. Unauthorized reproduction, distribution, or modification of this program, or any portion of it, may result in severe civil and criminal penalties, and will be prosecuted to the maximum extent possible under the law.\n\n"
                            "INCOLLEGE is a trademark of Group 3 SE. Any use of this trademark without express written permission from Group 3 SE is strictly prohibited.").pack(padx=10, pady=10)
        
        # Create back button
        backButton = tk.Button(self, text="Back", command=lambda: controller.show_frame("MainMenu"))
        backButton.pack(padx=10, pady=10)

class InCollegeFeaturesFrame(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        
        tk.Label(self, text="InCollege Features").pack(pady=10)
        tk.Label(self, text="InCollege is a social networking platform designed specifically for college students, alumni, and faculty members. With InCollege, users can create a professional profile, connect with classmates and colleagues, join interest groups, and explore career opportunities.").pack(pady=10)
        tk.Label(self, text="One of the main features of InCollege is the ability to connect with other users based on shared interests or career aspirations. Users can join or create interest groups focused on specific industries, job functions, or hobbies, making it easy to find and connect with like-minded individuals.").pack(pady=10)
        tk.Label(self, text="InCollege also provides a job search feature, where users can search for job opportunities and internships based on their field of study, location, or career interests. Employers can also use the platform to post job listings and connect with potential candidates.").pack(pady=10)
        tk.Label(self, text="Overall, InCollege is a powerful tool for college students and alumni who are looking to expand their professional networks and explore career opportunities. Whether you're a recent graduate looking for your first job, or an established professional looking to connect with others in your field, InCollege has something to offer.").pack(pady=10)
...
class AccessibilityNoticeFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="""Accessibility Notice:\n\n
                               ...
                               We welcome your feedback and are committed to ensuring that our software is accessible to all users.""").pack(padx=10, pady=10)
...
class UserAgreementFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text=("""InCollege User Agreement\n
                                Please read this User Agreement carefully before using the InCollege application (the "Application"). By using the Application, you agree to be bound 
                                by the terms and conditions of this Agreement.\n
                                Use of the Application\n
                                The InCollege Application is designed to help users create a professional network and explore career opportunities. By using the Application, you agree 
                                to use it only for lawful purposes and in accordance with this Agreement.\n
                                User Conduct\n
                                You agree to use the Application in a responsible manner and to comply with all applicable laws and regulations. You may not use the Application to engage 
                                in any conduct that is prohibited by law or that interferes with the rights of others.\n
                                User Content\n
                                ...
                                THE APPLICATION IS PROVIDED "AS IS" AND WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, WARRANTIES OF MERCHANTABILITY, 
                                FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. INCOLLEGE DOES NOT WARRANT THAT THE APPLICATION WILL BE UNINTERRUPTED OR ERROR-FREE, OR THAT ANY DEFECTS WILL BE CORRECTED.
                                Limitation of Liability\n
                                IN NO EVENT WILL INCOLLEGE BE LIABLE TO YOU FOR ANY INDIRECT, SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGES ARISING OUT OF OR IN CONNECTION WITH THE APPLICATION, INCLUDING, BUT NOT LIMITED TO, LOST PROFITS, LOSS OF USE, OR DATA LOSS, WHETHER IN AN ACTION IN CONTRACT, TORT (INCLUDING NEGLIGENCE), OR OTHERWISE, EVEN IF INCOLLEGE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
                                Governing Law\n
                                This Agreement shall be governed by and construed in accordance with the laws of the jurisdiction in which InCollege is located, without regard to its conflict of laws principles.\n
                                Entire Agreement\n\
                                ...
                                By using the InCollege Application, you acknowledge that you have read and understand this User Agreement and agree to be bound by its terms and conditions.""")).pack(padx=10, pady=10)
...
class MainWindow(tk.Tk):
  def __init__(self, *args, **kwargs):
    ...
    for F in (MainMenu, LoginWindow, SignUpWindow,
              ...
              InCollegeFeaturesFrame, AccessibilityNoticeFrame, UserAgreementFrame,
